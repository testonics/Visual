...
public class VisualComparison {
    ...
    /**
     * The percent of the allowing pixels to be different to stay {@link VisualComparisonState#MATCH} for comparison.
    ...
    /**
     * Say if provided {@param countOfDifferentPixels} is allowed for {@link VisualComparisonState#MATCH} state.
     *
     * @param countOfDifferentPixels the count of the different pixels in comparison.
     * @return true, if percent of different pixels lower or equal {@link VisualComparison#allowingPercentOfDifferentPixels},
     * false - otherwise.
     */
    ...
    private void saveImageForDestination(BufferedImage image) {
        if (Objects.nonNull(destination)) {
            VisualComparisonUtil.saveImage(destination, image);
        }
    }
    ...
    public VisualComparison setPixelToleranceLevel(double pixelToleranceLevel) {
    ...
    public VisualComparison setDrawExcludedRectangles(boolean drawExcludedRectangles) {
    ...
    public VisualComparison setThreshold(int threshold) {
    ...
    public VisualComparison setDestination(File destination) {
        this.destination = destination;
        return this;
    }
    ...
    public VisualComparison setRectangleLineWidth(int rectangleLineWidth) {
    ...
    public VisualComparison setMinimalRectangleSize(Integer minimalRectangleSize) {
    ...
    public VisualComparison setMaximalRectangleCount(Integer maximalRectangleCount) {
        this.maximalRectangleCount = maximalRectangleCount;
        return this;
    }

    public VisualComparison setExcludedAreas(List<Rectangle> excludedAreas) {
    ...
    public VisualComparison setDifferenceRectangleFilling(boolean fillRectangles, double percentOpacity) {
    ...
    public VisualComparison setExcludedRectangleFilling(boolean fillRectangles, double percentOpacity) {
    ...
    public VisualComparison setAllowingPercentOfDifferentPixels(double allowingPercentOfDifferentPixels) {
    ...
    public VisualComparison setDifferenceRectangleColor(Color differenceRectangleColor) {
